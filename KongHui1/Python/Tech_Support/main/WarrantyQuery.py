...
def send_get_warranty_list(url, token, params):
    headers = {
...
def get_warranty_list(hardware_id=None):
    token=load_token_from_config()
    params={
        'hardwareId':hardware_id,
    }
    result=send_get_warranty_list(url, token=token, params=params)
    ...
    print(rows)  # 打印合并后的结果
# get_warranty_list('67G11299-H406-4E35-BM83-95E70FR561T0')
get_warranty_list()